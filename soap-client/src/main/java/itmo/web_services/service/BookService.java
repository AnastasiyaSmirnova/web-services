 ...
 * 
 */
@WebServiceClient(name = "BookService", targetNamespace = "http://service.web_services.itmo/", wsdlLocation = "http://localhost:8080/BookService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICE_QNAME = new QName("http://service.web_services.itmo/", "BookService");
    ...
    public BooksWebService getBooksWebServicePort() {
        return super.getPort(new QName("http://service.web_services.itmo/", "BooksWebServicePort"), BooksWebService.class);
    }
    ...
    public BooksWebService getBooksWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.web_services.itmo/", "BooksWebServicePort"), BooksWebService.class, features);
    }
